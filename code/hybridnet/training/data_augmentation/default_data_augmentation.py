...
from hybridnet.training.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform
from hybridnet.training.data_augmentation.pyramid_augmentations import MoveSegAsOneHotToData, \
    ApplyRandomBinaryOperatorTransform, \
    RemoveRandomConnectedComponentFromOneHotEncodingTransform
from hybridnet.utilities.set_n_proc_DA import get_allowed_n_proc_DA
...
default_3D_augmentation_params = {
    ...
    "num_threads": min(os.cpu_count(), int(os.environ['nnUNet_num_proc'])),
...
if __name__ == "__main__":
    from hybridnet.training.dataloading.dataset_loading import DataLoader3D, load_dataset
