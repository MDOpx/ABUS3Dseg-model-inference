...
def main():
    ...
    from nnunet.network_architecture.static_UNet import Static_UNet, Conv3dBlock, Conv3dVBlock, ResConv3dBlock, ResConv3dBlockRev3, Dense3dBlock_CBR, ResConv3dTFBlock
    ...
    elif args.model_arch == 'Multitask':
        model_arch = Multitask
    elif args.model_arch == 'Multitask6L':
        model_arch = Multitask6L
    elif args.model_arch == 'MultitaskAG':
        model_arch = MultitaskAG
    elif args.model_arch == 'MultitaskCLS':
        model_arch = MultitaskCLS
    elif args.model_arch == 'MultitaskDET':
        model_arch = MultitaskDET
    else:
        raise KeyError
    
    trainer: nnUNetTrainerCascadeFullRes | nnUNetTrainerV2CascadeFullRes | nnUNetTrainer = trainer_class(plans_file, fold, output_folder=output_folder_name, dataset_directory=dataset_directory,
