...
from hybridnet.experiment_planning.common_utils import get_pool_and_conv_props
from hybridnet.experiment_planning.experiment_planner_baseline_3DUNet_v21 import \
    ExperimentPlanner3D_v21
from hybridnet.network_architecture.generic_modular_residual_UNet import FabiansUNet
from hybridnet.paths import *
from hybridnet.training.model_restore import recursive_find_python_class


class ExperimentPlanner3D_residual_v21_bfnnUNet(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_v21, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_bfnnUNet"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlans_bfnnUNet_fabresnet_plans_3D.pkl")
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        ref = FabiansUNet.use_this_for_3D_configuration * 15 / 8
...
class ExperimentPlanner3D_residual_v21_bfnnUNet_31_spRegnnU(ExperimentPlanner3D_residual_v21_bfnnUNet_31):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super().__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_bfnnUNet_31_spnnU"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlans_bfnnUNet_fabresnet_31_spnnU_plans_3D.pkl")
        self.preprocessor_name = 'Preprocessor3DBetterResampling'

    def get_target_spacing(self):
        return np.array([2., 0.68825001, 0.68825001])
